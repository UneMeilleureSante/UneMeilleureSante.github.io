...
<script type="text/javascript" async="" src="watch.js"></script><script>
			window.language="th";
			window.cdn_path="//evrhst-a.akamaihd.net/6911/";
			window.country_code="";
...
<body data-invalid-email-text="ไม่ถูกต้อง E-mail" data-invalid-name-text="กรุณาระบุชื่อที่ถูกต้อง" data-invalid-phone-text="กรุณาระบุหมายเลขโทรศัพท์ที่ถูกต้อง ไม่เช่นนั้นเราจะไม่สามารถติดต่อกับคุณได้">
	...
	<div class="footer">
		<div class="wraper-footer">
			<a href="http://healthy-tip.icu/landings/DitonicaTH/mar/IRp14/privacy.html" class="politic" target="_blank">นโยบายความเป็นส่วนตัว</a>
		</div>
	</div>
		<!-- Facebook Pixel Code -->
		<script>
		...
		fbq('init', '1948096835497241'); // Insert your pixel ID here.
		fbq('track', 'PageView');
		fbq('track', 'Lead');
		</script>
		<noscript><img height="1" width="1" style="display:none"
		src="https://www.facebook.com/tr?id=1948096835497241&ev=PageView&noscript=1"
		/></noscript>
		<!-- DO NOT MODIFY -->
